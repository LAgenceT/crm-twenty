...
export const SLACK_INTERACTIVITY_ROUTE_UNIVERSAL_IDENTIFIER =
  'fd756b00-50a2-4816-a919-a1a959a2ed9a';

export const SLACK_ASSISTANT_FEEDBACK_UNIVERSAL_IDENTIFIER =
  '60947582-0735-4b6d-8c1f-5e237875a2e4';

export const SLACK_CHANNEL_WELCOME_UNIVERSAL_IDENTIFIER =
  'c5e8b13a-7f42-4d90-8a6b-1e3c9d052f47';

export const SLACK_HOME_OPENED_UNIVERSAL_IDENTIFIER =
  '0ab0156f-11eb-49d6-bda2-cf078638886c';
...
export const SLACK_SET_USER_LINK_UNIVERSAL_IDENTIFIER =
  '32f511ac-8754-4526-8c28-e17221f2e2b0';
...
export const SLACK_INSTALL_REVOKED_LOGIC_FUNCTION_UNIVERSAL_IDENTIFIER =
  '144d8fcc-d44b-46a2-bb19-0d11533db9cb';
...
export const SLACK_ASSISTANT_REQUEST_FEEDBACK_RATING_FIELD_UNIVERSAL_IDENTIFIER =
  '9b7d83e1-e526-474b-8d93-dad5c0a4a6aa';
...
export const SLACK_USER_LINK_OBJECT_UNIVERSAL_IDENTIFIER =
  'ebb881f5-7ce9-4f24-be1d-499323d3c292';

export const SLACK_USER_LINK_NAME_FIELD_UNIVERSAL_IDENTIFIER =
  'b75993d1-f96a-402d-a46c-2c928043fc58';

export const SLACK_USER_LINK_TEAM_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '69ec7ead-80f3-43f5-8a6f-c71880a6588c';

export const SLACK_USER_LINK_USER_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '0b7c2fb7-6b5d-4a6d-abbc-6f3ceddd7fc8';

export const SLACK_USER_LINK_SOURCE_FIELD_UNIVERSAL_IDENTIFIER =
  '28ea1176-1a5a-4f7f-82d9-56927a6e4af0';

export const SLACK_USER_LINK_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'a46fa5a5-bb6f-4474-9ba4-b816ab743d0d';

export const SLACK_USER_LINKS_ON_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'dbccb29b-a50f-47b0-9232-852a12d874cb';

export const SLACK_USER_LINK_SLACK_USER_INDEX_UNIVERSAL_IDENTIFIER =
  '88085b27-6176-4196-9445-646d3fafac9b';

export const SLACK_USER_LINK_SLACK_USER_INDEX_TEAM_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '0d0b3215-9ec1-4761-b615-50f818567441';

export const SLACK_USER_LINK_SLACK_USER_INDEX_USER_ID_FIELD_UNIVERSAL_IDENTIFIER =
  '725a24ac-ec71-4129-9f47-6f5e5719f1b3';

export const SLACK_ASSISTANT_REQUEST_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'ca74ef58-49ad-4dd5-a9e0-5247378e548c';

export const SLACK_ASSISTANT_REQUESTS_ON_WORKSPACE_MEMBER_FIELD_UNIVERSAL_IDENTIFIER =
  'c837dafb-1e41-46de-8eab-076f2667eed6';

export const SLACK_USER_LINKS_SETTINGS_FRONT_COMPONENT_UNIVERSAL_IDENTIFIER =
  '20beb6d2-804f-40a5-ad7d-8d523e401651';

export const SLACK_USER_LINKS_CAN_MANAGE_UNIVERSAL_IDENTIFIER =
  '072b19be-e9da-4d6f-806d-bc3ffbdde456';
